...
export function DesignCodeISParams() {
  ...
  const params = useMemo(() => ui?.designCodeAndParametersUI.indianDesignCode, [
    ui,
  ]);
  ...
  function handleAddRow() {
    if (!params) return;
    if (tab === "EL") {
      handleChangeParams("effectiveLengths", [
        ...params.effectiveLengths,
        {
          id: getNextId(params.effectiveLengths),
          selected: false,
          Ky: 1,
          Kz: 1,
          Ly: 0,
      ...
      handleChangeParams("deflectionLengths", [
        ...(params.deflectionLengths ?? []),
        {
          id: getNextId(params.deflectionLengths ?? []),
          selected: false,
          dl: 0,
        },
      ]);
