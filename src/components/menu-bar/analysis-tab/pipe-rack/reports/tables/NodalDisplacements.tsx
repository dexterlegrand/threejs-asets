...
import { PipeRack, Project, TNodeDisplacement } from "../../../../../../store/main/types";
...
export function NodalDisplacements(props: Props) {
  const { models } = props;
  ...
  function drawRows(item: TNodeDisplacement) {
    return (
  ...
  const [selectedRows, setSelectedRows] = useState<TNodeDisplacement[]>([]);
