...
import { TDeflectionCheck, PipeRack } from "../../../../../../store/main/types";
...
export function DeflectionCheck(props: Props) {
  const { models } = props;
  ...
  function drawRows(item: TDeflectionCheck) {
    return (
  ...
  const [selectedRows, setSelectedRows] = useState<TDeflectionCheck[]>([]);
