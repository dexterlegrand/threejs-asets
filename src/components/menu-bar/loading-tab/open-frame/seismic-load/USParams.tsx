...
import { SeismicLoadsUI, WindLoadUI } from "../../../../../store/ui/types";
...
export function USParamsOF({ data, windData, onChange }: Props) {
    ...
    <div className="d-flex f-grow bg-dark p-5">
      <div className="d-flex f-grow bg-gray" style={{ paddingRight: 10 }}>
        ...
        <div className="d-flex f-grow f-column">
          ...
          <div className="d-flex f-ai-center">
            <div className="label-light t-end w-150">Datum Elevation</div>
            <FormGroup className="no-m">{windData?.usWindCode.datumElevation ?? 0}m</FormGroup>
          </div>
          {/*NEXT INPUT*/}
        </div>
        {/*NEXT COLUMN*/}
