...
import { DirectLoadsImportParamsFS } from "./DirectLoadsImportParams";
...
export function DirectLoadsFS({ onClose }: Props) {
  ...
  function handleExportToCSV() {
    exportToCSV(data, "FS Direct Piping Load");
  }
