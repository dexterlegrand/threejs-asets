...
export function ISParamsPP({ data, onChange }: Props) {
  function handleChangeData(field: string, value: any) {
    onChange("isWindCode", { ...data.isWindCode, [field]: value });
  }
      ...
      <div className="d-flex f-grow f-column bg-gray f-ai-end" style={{ paddingRight: 20 }}>
        ...
        <div className="d-flex f-ai-center">
          ...
          <FormGroup className="no-m">
            <SimpleNumericInput
              isDecimal={true}
              value={data.isWindCode.shapeFactor}
        ...
        <div className="d-flex f-ai-center">
          ...
          <FormGroup className="no-m">
            <SimpleNumericInput
              min={0}
              isDecimal={true}
              value={data.isWindCode.datumElevation}
        ...
        <div className="d-flex f-ai-center">
          ...
          <FormGroup className="no-m">
            <SimpleNumericInput
              min={0}
              isDecimal={true}
              value={data.isWindCode.limitingSize}
